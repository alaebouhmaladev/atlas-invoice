<template>
  <div class="max-w-5xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h2 class="text-2xl font-bold text-slate-100 tracking-tight">Modifier le Brouillon de Facture</h2>
        <p class="text-xs text-slate-400">Facture non finalisée.</p>
      </div>
    </div>
    ...
    <div v-if="loading && !invoice" class="p-12 text-center text-slate-400">
      ...
      <p class="text-xs">Chargement du brouillon...</p>
    </div>
