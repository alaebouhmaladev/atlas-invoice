  ...
  <div class="flex items-center gap-2 flex-wrap">
    ...
    <template v-else-if="quote.status === 'REJECTED'">
      <button
        ...
        :disabled="loading"
        class="px-3.5 py-2 bg-brand-soft hover:bg-brand-strong/20 text-brand-strong border border-brand-soft rounded-control text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
      >
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <button
      ...
      :disabled="loading"
      class="px-3.5 py-2 bg-brand text-on-brand hover:bg-brand-strong rounded-control text-xs font-bold shadow-sm transition-colors flex items-center gap-1.5 cursor-pointer"
    >
      <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
