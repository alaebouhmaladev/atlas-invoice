    ...
    <div class="flex items-center gap-3">
      ...
      <div class="relative">
        <button
          ...
          class="px-3 py-1.5 bg-brand hover:opacity-90 text-slate-950 font-bold text-xs rounded-pill shadow-sm transition-all flex items-center gap-1.5 cursor-pointer"
        >
