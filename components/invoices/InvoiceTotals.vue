<template>
  <div class="bg-panel border border-custom rounded-card p-5 space-y-3 shadow-soft">
    ...
    <div class="space-y-2 text-xs">
      ...
      <div v-if="amountPaid !== undefined" class="pt-2 border-t border-custom space-y-1.5 text-xs">
        ...
        <div class="flex justify-between text-rose-600 dark:text-rose-400 font-bold">
          ...
          <span class="font-mono text-sm font-black">{{ formatMoney(amountDue || 0) }}</span>
        </div>
      </div>
    </div>
  </div>
