        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-4 text-xs">
          ...
          <div class="pt-3 border-t border-custom flex justify-end gap-2">
            ...
            <button
              type="submit"
              :disabled="loading"
              class="px-5 py-2 bg-brand hover:opacity-90 text-slate-950 font-bold rounded-pill text-xs shadow-sm transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
            >
